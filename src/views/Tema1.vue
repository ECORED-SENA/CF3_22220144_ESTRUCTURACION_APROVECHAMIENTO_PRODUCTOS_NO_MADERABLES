  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5    
    ...
    .fondo1.pt-5.mb-4(data-aos="fade-left")
      ...
      #t_1_1.titulo-segundo.color-acento-contenido
        h2 1.1. Manufactura de productos
        ...
        .tabla-b.color-acento-contenido
          table        
            ...
            tr(style="background-color: white")
              td(colspan=6) Ley 99 de 1993
              td(colspan=1 align="center").ps-0
                 a.anexo.w-100.px-0.ps-5(href="https://funcionpublica.gov.co/eva/gestornormativo/norma.php?i=297" target="_blank")
                  .anexo__icono
            ...
            tr(style="background-color: #F0F0F0")
              ...
              td(colspan=1 align="center").ps-0
                 a.anexo.w-100.px-0.ps-5(href="https://funcionpublica.gov.co/eva/gestornormativo/norma.php?i=78153" target="_blank")
                  .anexo__icono
                    img(src="@/assets/curso/tema1/img12.svg")
                  .anexo__texto
                    p Enlace web.
            tr(style="background-color: white")
              ...
              td(colspan=1 align="center").ps-0
                 a.anexo.w-100.px-0.ps-5(href="https://www.redjurista.com/Documents/resolucion_224_de_2017_ministerio_de_agricultura_y_desarrollo_rural.aspx#/" target="_blank")
                  .anexo__icono
                    img(src="@/assets/curso/tema1/img12.svg")
                  .anexo__texto
                    p Enlace web.    
            tr(style="background-color: #F0F0F0")
              ...
              td(colspan=1 align="center").ps-0
                 a.anexo.w-100.px-0.ps-5(href="https://www.redjurista.com/Documents/acuerdo_28_de_2004_car_-_corporacion_autonoma_regional_de_cundinamarca.aspx#/" target="_blank")
                  .anexo__icono
                    img(src="@/assets/curso/tema1/img12.svg")
                  .anexo__texto
                    p Enlace web.    
